// FIXME: get rid of this once https://github.com/DefinitelyTyped/DefinitelyTyped/pull/73815 gets merged
...
declare module "react-reconciler" {
	...
	namespace ReactReconciler {
		...
		> {
			...
			//
			// To support hydration, you need to  `supportsHydration: true` and then implement the methods in the "Hydration" section [listed in this file](https://github.com/facebook/react/blob/master/packages/react-reconciler/src/forks/ReactFiberConfig.custom.js). File an issue if you need help.
			// -------------------
		...
		> {
			createContainer(
				...
				onUncaughtError: (
					error: Error,
					info: BaseErrorInfo & { errorBoundary?: Component },
				) => void,
