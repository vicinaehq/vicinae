 ...
 * After some amount of testing, it looks like it does not replicate every behavior perfectly, most notably
 * when it comes to word order. It is however close enough to justify its use, but we might have to hack on it
 * in the future.
 */
