...
%1
```</source>
        <translation># Розширення аварійно завершилося 💥!

Це розширення викликало необроблений виняток і через це завершилося.

Повна траса стека — нижче. Її також можна скопіювати з меню дій.
...
Скоро повернемося до команди...</translation>
    </message>
</context>
<context>
...
Vicinae provides direct integration with the official [Raycast store](https://www.raycast.com/store), allowing you to search and install Raycast extensions directly from Vicinae.
        ...
        <translation># Ласкаво просимо до магазину розширень Raycast
...
Vicinae also has its own [extension store](vicinae://launch/core/store), which does not suffer from these limitations.
        ...
        <translation>У кожного розширення є кольоровий індикатор сумісності, який показує, наскільки добре воно працює в Linux.
