#include "ui/quick/source-blend-rect.hpp"
#include <QSGGeometry>
...
public:
  SourceBlendShader() {
    setShaderFileName(VertexStage, QStringLiteral(":/shaders/sourceblend.vert.qsb"));
    setShaderFileName(FragmentStage, QStringLiteral(":/shaders/sourceblend.frag.qsb"));
