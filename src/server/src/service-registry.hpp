...
public:
  ...
  AI::ConversationStore *conversations() const;
  ...
  void setConversations(std::unique_ptr<AI::ConversationStore> store);
...
private:
  ...
  std::unique_ptr<AI::ConversationStore> m_conversations;
};
