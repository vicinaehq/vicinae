...
QString QmlInstalledExtensionsModel::displayTitle(const ExtensionManifest &m) const {
  return m.title;
}

QString QmlInstalledExtensionsModel::displaySubtitle(const ExtensionManifest &m) const {
  return m.description;
}

QString QmlInstalledExtensionsModel::displayIconSource(const ExtensionManifest &m) const {
  if (!m.icon.isEmpty()) {
...
QString QmlInstalledExtensionsModel::displayAccessory(const ExtensionManifest &m) const {
...
QmlInstalledExtensionsModel::buildActionPanel(const ExtensionManifest &m) const {
...
QString QmlInstalledExtensionsModel::sectionLabel() const {
