        ...
        Item {
            ...
            TextInput {
                ...
                Keys.onLeftPressed: event => {
                    if (event.modifiers === Qt.NoModifier && commandStack.currentItem && typeof commandStack.currentItem.moveLeft === "function" && commandStack.currentItem.moveLeft()) {
                        event.accepted = true;
                    } else {
                ...
                Keys.onRightPressed: event => {
                    if (event.modifiers === Qt.NoModifier && commandStack.currentItem && typeof commandStack.currentItem.moveRight === "function" && commandStack.currentItem.moveRight()) {
                        event.accepted = true;
                    } else {
                        event.accepted = false;
                    }
