...
QmlSystemRunModel::DefaultAction QmlSystemRunModel::parseDefaultAction(QStringView s) {
...
void QmlSystemRunModel::setData(std::vector<std::string> cmdline, bool hasProgram,
...
const RunProgramItem &QmlSystemRunModel::itemAt(int section, int item) const {
...
QString QmlSystemRunModel::itemTitle(int section, int item) const {
...
QString QmlSystemRunModel::itemSubtitle(int section, int item) const {
  const auto &entry = itemAt(section, item);
  return std::visit(
...
QString QmlSystemRunModel::itemIconSource(int section, int item) const {
  const auto &entry = itemAt(section, item);
  return std::visit(
...
std::unique_ptr<ActionPanelState> QmlSystemRunModel::createActionPanel(int section, int item) const {
  const auto &entry = itemAt(section, item);
