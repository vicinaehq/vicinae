...
QmlCreateExtensionSuccessViewHost::QmlCreateExtensionSuccessViewHost(
...
QUrl QmlCreateExtensionSuccessViewHost::qmlComponentUrl() const {
  return QUrl(QStringLiteral("qrc:/Vicinae/MarkdownDetailView.qml"));
}

QVariantMap QmlCreateExtensionSuccessViewHost::qmlProperties() const {
  return {{QStringLiteral("markdown"), m_markdown}};
}

void QmlCreateExtensionSuccessViewHost::initialize() {
  BaseView::initialize();
