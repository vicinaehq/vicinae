...
const std::vector<CategoryInfo> &categories() {
  static const std::vector<CategoryInfo> v = {
      ...
      {FontCategory::Japanese, QStringLiteral("Japanese"), QStringLiteral("あ")},
      {FontCategory::Korean, QStringLiteral("Korean"), QStringLiteral("한")},
      {FontCategory::SimplifiedChinese, QStringLiteral("Simplified Chinese"), QStringLiteral("汉")},
      {FontCategory::TraditionalChinese, QStringLiteral("Traditional Chinese"), QStringLiteral("漢")},
      {FontCategory::Arabic, QStringLiteral("Arabic"), QStringLiteral("أب")},
      {FontCategory::Hebrew, QStringLiteral("Hebrew"), QStringLiteral("אב")},
      {FontCategory::Thai, QStringLiteral("Thai"), QStringLiteral("ก")},
      {FontCategory::Lao, QStringLiteral("Lao"), QStringLiteral("ກ")},
      {FontCategory::Devanagari, QStringLiteral("Devanagari"), QStringLiteral("अ")},
      {FontCategory::Bengali, QStringLiteral("Bengali"), QStringLiteral("অ")},
      {FontCategory::Gurmukhi, QStringLiteral("Gurmukhi"), QStringLiteral("ਅ")},
      {FontCategory::Gujarati, QStringLiteral("Gujarati"), QStringLiteral("અ")},
      {FontCategory::Tamil, QStringLiteral("Tamil"), QStringLiteral("அ")},
      {FontCategory::Telugu, QStringLiteral("Telugu"), QStringLiteral("అ")},
      {FontCategory::Kannada, QStringLiteral("Kannada"), QStringLiteral("ಅ")},
      {FontCategory::Malayalam, QStringLiteral("Malayalam"), QStringLiteral("അ")},
      {FontCategory::Sinhala, QStringLiteral("Sinhala"), QStringLiteral("අ")},
      {FontCategory::Armenian, QStringLiteral("Armenian"), QStringLiteral("Աա")},
      {FontCategory::Georgian, QStringLiteral("Georgian"), QStringLiteral("ა")},
      {FontCategory::Thaana, QStringLiteral("Thaana"), QStringLiteral("ތ")},
      {FontCategory::Tibetan, QStringLiteral("Tibetan"), QStringLiteral("ཀ")},
      {FontCategory::Myanmar, QStringLiteral("Myanmar"), QStringLiteral("က")},
      {FontCategory::Khmer, QStringLiteral("Khmer"), QStringLiteral("ក")},
      {FontCategory::Syriac, QStringLiteral("Syriac"), QString()},
      {FontCategory::Ogham, QStringLiteral("Ogham"), QString()},
      {FontCategory::Runic, QStringLiteral("Runic"), QString()},
      {FontCategory::Nko, QStringLiteral("N'Ko"), QString()},
      {FontCategory::Symbols, QStringLiteral("Symbols"), QString()},
  };
  return v;
}
