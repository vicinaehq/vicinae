...
export const CloseMainWindowRequest: MessageFns<CloseMainWindowRequest> = {
  ...
  fromPartial<I extends Exact<DeepPartial<CloseMainWindowRequest>, I>>(object: I): CloseMainWindowRequest {
    const message = createBaseCloseMainWindowRequest();
...
function createBaseShowInFileBrowserRequest(): ShowInFileBrowserRequest {
  return { path: "", select: false };
}

export const ShowInFileBrowserRequest: MessageFns<ShowInFileBrowserRequest> = {
  encode(message: ShowInFileBrowserRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.path !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): ShowInFileBrowserRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
  ...
  fromJSON(object: any): ShowInFileBrowserRequest {
    return {
  ...
  toJSON(message: ShowInFileBrowserRequest): unknown {
    const obj: any = {};
    if (message.path !== "") {
  ...
  create<I extends Exact<DeepPartial<ShowInFileBrowserRequest>, I>>(base?: I): ShowInFileBrowserRequest {
    return ShowInFileBrowserRequest.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<ShowInFileBrowserRequest>, I>>(object: I): ShowInFileBrowserRequest {
    const message = createBaseShowInFileBrowserRequest();
...
export const ConfirmAlertResponse: MessageFns<ConfirmAlertResponse> = {
  ...
  create<I extends Exact<DeepPartial<ConfirmAlertResponse>, I>>(base?: I): ConfirmAlertResponse {
    return ConfirmAlertResponse.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<ConfirmAlertResponse>, I>>(object: I): ConfirmAlertResponse {
    const message = createBaseConfirmAlertResponse();
...
export const PopToRootRequest: MessageFns<PopToRootRequest> = {
  ...
  create<I extends Exact<DeepPartial<PopToRootRequest>, I>>(base?: I): PopToRootRequest {
    return PopToRootRequest.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<PopToRootRequest>, I>>(object: I): PopToRootRequest {
    const message = createBasePopToRootRequest();
...
export const Request: MessageFns<Request> = {
  encode(message: Request, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.showInFileBrowser !== undefined) {
      ShowInFileBrowserRequest.encode(message.showInFileBrowser, writer.uint32(114).fork()).join();
    }
    return writer;
  },
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 14: {
          ...
          message.showInFileBrowser = ShowInFileBrowserRequest.decode(reader, reader.uint32());
          continue;
        }
      }
      if ((tag & 7) === 4 || tag === 0) {
  ...
  fromJSON(object: any): Request {
    return {
      ...
      getSelectedText: isSet(object.getSelectedText)
        ...
        : undefined,
      popToRoot: isSet(object.popToRoot) ? PopToRootRequest.fromJSON(object.popToRoot) : undefined,
      showInFileBrowser: isSet(object.showInFileBrowser)
        ? ShowInFileBrowserRequest.fromJSON(object.showInFileBrowser)
        : undefined,
    };
  },
  ...
  toJSON(message: Request): unknown {
    ...
    if (message.showInFileBrowser !== undefined) {
      obj.showInFileBrowser = ShowInFileBrowserRequest.toJSON(message.showInFileBrowser);
    }
    return obj;
  },
  ...
  fromPartial<I extends Exact<DeepPartial<Request>, I>>(object: I): Request {
    ...
    message.popToRoot = (object.popToRoot !== undefined && object.popToRoot !== null)
      ? PopToRootRequest.fromPartial(object.popToRoot)
      : undefined;
    message.showInFileBrowser = (object.showInFileBrowser !== undefined && object.showInFileBrowser !== null)
      ? ShowInFileBrowserRequest.fromPartial(object.showInFileBrowser)
      : undefined;
    return message;
  },
};
...
export const Response: MessageFns<Response> = {
  encode(message: Response, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.showInFileBrowser !== undefined) {
      AckResponse.encode(message.showInFileBrowser, writer.uint32(114).fork()).join();
    }
    return writer;
  },
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 14: {
          ...
          message.showInFileBrowser = AckResponse.decode(reader, reader.uint32());
          continue;
        }
      }
      if ((tag & 7) === 4 || tag === 0) {
  ...
  fromJSON(object: any): Response {
    return {
      ...
      confirmAlert: isSet(object.confirmAlert) ? ConfirmAlertResponse.fromJSON(object.confirmAlert) : undefined,
      getSelectedText: isSet(object.getSelectedText)
        ? GetSelectedTextResponse.fromJSON(object.getSelectedText)
        : undefined,
      popToRoot: isSet(object.popToRoot) ? AckResponse.fromJSON(object.popToRoot) : undefined,
      showInFileBrowser: isSet(object.showInFileBrowser) ? AckResponse.fromJSON(object.showInFileBrowser) : undefined,
    };
  },
  ...
  toJSON(message: Response): unknown {
    ...
    if (message.showInFileBrowser !== undefined) {
      obj.showInFileBrowser = AckResponse.toJSON(message.showInFileBrowser);
    }
    return obj;
  },
  ...
  fromPartial<I extends Exact<DeepPartial<Response>, I>>(object: I): Response {
    ...
    message.setSearchText = (object.setSearchText !== undefined && object.setSearchText !== null)
      ...
      : undefined;
    message.confirmAlert = (object.confirmAlert !== undefined && object.confirmAlert !== null)
      ? ConfirmAlertResponse.fromPartial(object.confirmAlert)
      : undefined;
    message.getSelectedText = (object.getSelectedText !== undefined && object.getSelectedText !== null)
      ? GetSelectedTextResponse.fromPartial(object.getSelectedText)
      : undefined;
    message.popToRoot = (object.popToRoot !== undefined && object.popToRoot !== null)
      ? AckResponse.fromPartial(object.popToRoot)
      : undefined;
    message.showInFileBrowser = (object.showInFileBrowser !== undefined && object.showInFileBrowser !== null)
      ? AckResponse.fromPartial(object.showInFileBrowser)
      : undefined;
    return message;
  },
};
...
function createBaseDynamicColor(): DynamicColor {
  return { light: "", dark: "", adjustContrast: undefined };
}

export const DynamicColor: MessageFns<DynamicColor> = {
  encode(message: DynamicColor, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.light !== "") {
      writer.uint32(10).string(message.light);
    }
    if (message.dark !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): DynamicColor {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
  ...
  fromJSON(object: any): DynamicColor {
    return {
      light: isSet(object.light) ? globalThis.String(object.light) : "",
      dark: isSet(object.dark) ? globalThis.String(object.dark) : "",
  ...
  toJSON(message: DynamicColor): unknown {
    const obj: any = {};
    if (message.light !== "") {
      obj.light = message.light;
    }
  ...
  create<I extends Exact<DeepPartial<DynamicColor>, I>>(base?: I): DynamicColor {
    return DynamicColor.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<DynamicColor>, I>>(object: I): DynamicColor {
    const message = createBaseDynamicColor();
    message.light = object.light ?? "";
    message.dark = object.dark ?? "";
...
function createBaseColorLike(): ColorLike {
  return { raw: undefined, dynamic: undefined };
}

export const ColorLike: MessageFns<ColorLike> = {
  encode(message: ColorLike, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.raw !== undefined) {
      writer.uint32(10).string(message.raw);
    }
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): ColorLike {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
  ...
  fromJSON(object: any): ColorLike {
    return {
      raw: isSet(object.raw) ? globalThis.String(object.raw) : undefined,
      dynamic: isSet(object.dynamic) ? DynamicColor.fromJSON(object.dynamic) : undefined,
    };
  },

  toJSON(message: ColorLike): unknown {
    const obj: any = {};
    if (message.raw !== undefined) {
      obj.raw = message.raw;
    }
  ...
  create<I extends Exact<DeepPartial<ColorLike>, I>>(base?: I): ColorLike {
    return ColorLike.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<ColorLike>, I>>(object: I): ColorLike {
    const message = createBaseColorLike();
    message.raw = object.raw ?? undefined;
    message.dynamic = (object.dynamic !== undefined && object.dynamic !== null)
      ? DynamicColor.fromPartial(object.dynamic)
      : undefined;
    return message;
  },
};
...
export const Image: MessageFns<Image> = {
  ...
  fromJSON(object: any): Image {
    return {
      ...
      tintColor: isSet(object.tintColor) ? ColorLike.fromJSON(object.tintColor) : undefined,
    };
  },
  ...
  fromPartial<I extends Exact<DeepPartial<Image>, I>>(object: I): Image {
    ...
    message.tintColor = (object.tintColor !== undefined && object.tintColor !== null)
      ? ColorLike.fromPartial(object.tintColor)
      : undefined;
    return message;
  },
};
