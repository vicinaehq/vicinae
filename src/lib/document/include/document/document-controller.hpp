...
class DocumentController : public QObject {
  ...
  Q_PROPERTY(vicinae::document::DocumentModel *model READ model WRITE setModel NOTIFY modelChanged)
  ...
  Q_PROPERTY(vicinae::document::DocumentSearch *search READ search CONSTANT)
