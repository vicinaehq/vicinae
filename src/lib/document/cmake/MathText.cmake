function(document_fetch_mathtext)
	...
	FetchContent_Declare(jkqtmathtext
		...
		PATCH_COMMAND ${CMAKE_COMMAND} -E env "GIT_CEILING_DIRECTORIES=<SOURCE_DIR>/.."
			git apply --ignore-whitespace "${CMAKE_CURRENT_FUNCTION_LIST_DIR}/patches/jkqtmathtext-implication.patch"
			"${CMAKE_CURRENT_FUNCTION_LIST_DIR}/patches/jkqtmathtext-font-discovery.patch"
		EXCLUDE_FROM_ALL
	)
