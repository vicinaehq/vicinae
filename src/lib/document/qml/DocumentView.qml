...
Flickable {
    id: root
    property DocumentStyle style: DocumentStyle {}
    ...
    property var layoutKey: [root.style.fontFamily, root.style.monoFontFamily, root.style.regularFontSize, root.style.smallerFontSize]
