...
static std::vector<Contributor::Contributor> CONTRIB_LIST = {
    Contributor::Contributor{.login = "aurelleb", .resource = ":contribs/aurelleb", .contribs = 1145},
    ...
    Contributor::Contributor{
        .login = "koutselakismanos", .resource = ":contribs/koutselakismanos", .contribs = 2},
    ...
    Contributor::Contributor{.login = "UnknownCalculatedVariable",
                             .resource = ":contribs/UnknownCalculatedVariable",
                             .contribs = 1},
    Contributor::Contributor{
        .login = "dawnofmidnight", .resource = ":contribs/dawnofmidnight", .contribs = 1},
