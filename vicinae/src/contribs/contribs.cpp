...
static std::vector<Contributor::Contributor> CONTRIB_LIST = {
	Contributor::Contributor{.login = "aurelien-brabant", .resource = ":contribs/aurelien-brabant", .contribs = 969 },
Contributor::Contributor{.login = "cilginc", .resource = ":contribs/cilginc", .contribs = 40 },
Contributor::Contributor{.login = "dagimg-dot", .resource = ":contribs/dagimg-dot", .contribs = 21 },
...
Contributor::Contributor{.login = "TomRomeo", .resource = ":contribs/TomRomeo", .contribs = 4 },
