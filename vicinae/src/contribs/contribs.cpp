...
static std::vector<Contributor::Contributor> CONTRIB_LIST = {
	Contributor::Contributor{.login = "aurelien-brabant", .resource = ":contribs/aurelien-brabant", .contribs = 1066 },
Contributor::Contributor{.login = "cilginc", .resource = ":contribs/cilginc", .contribs = 40 },
Contributor::Contributor{.login = "quadratech188", .resource = ":contribs/quadratech188", .contribs = 24 },
Contributor::Contributor{.login = "dagimg-dot", .resource = ":contribs/dagimg-dot", .contribs = 23 },
...
Contributor::Contributor{.login = "falood", .resource = ":contribs/falood", .contribs = 1 },
