...
class CopyCalculatorAnswerAction : public AbstractAction {
  ...
  void execute(ApplicationContext *ctx) override {
    ...
    if (clip->copyText(m_item.answer.answer)) {
...
class CopyCalculatorQuestionAndAnswerAction : public AbstractAction {
  ...
  void execute(ApplicationContext *ctx) override {
    ...
    auto result = QString("%1 = %2").arg(m_item.question.question).arg(m_item.answer.answer);
...
class PutCalculatorAnswerInSearchBar : public AbstractAction {
  ...
  void execute(ApplicationContext *ctx) override { ctx->navigation->setSearchText(m_item.answer.answer); }
