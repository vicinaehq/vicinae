...
Stack RaycastStoreDetailView::createMainWidget() {
  return VStack()
      .add(VStack()
               .addText("Description")
               .addParagraph(m_ext.description, SemanticColor::LightForeground)
               .spacing(10))
      .add(VStack()
               .addText("Commands", SemanticColor::LightForeground)
               .add(VStack()
                        .map(m_ext.commands,
                             [&](const auto &cmd) {
                               return VStack()
                                   .add(HStack()
                                            ...
                                            .addText(cmd.title)
                                            .spacing(10))
                                   .addParagraph(cmd.description, SemanticColor::LightForeground)
                                   .spacing(10);
                             })
                        .divided(1)
                        .spacing(15)
...
QWidget *RaycastStoreDetailView::createSideMetadataSection() {
  ...
  return VStack()
      ...
      .addIf(!m_ext.contributors.isEmpty(),
             [&]() {
               return VStack()
                   .addText("Contributors", SemanticColor::LightForeground)
